...
def connDB():
    if socket.gethostname() == 'cat.com':
        ...
        conn=  pymysql.connect(host='192.168.81.204',port=3306,user='root',passwd='666666',db='monitor_v3',charset='utf8')
    try:
        conn.ping()
    except:
        conn.close()
    ...
    return (conn,cur)
def connDB_12():
    conn=  pymysql.connect(host='192.168.81.204',port=3306,user='root',passwd='666666',db='monitor',charset='utf8')
    cur = conn.cursor()
    return (conn,cur)
def connDB_13():
    conn=  pymysql.connect(host='192.168.81.204',port=3306,user='root',passwd='666666',db='duty',charset='utf8')
    cur = conn.cursor()
    return (conn,cur)
def connDB_14():
    conn=  pymysql.connect(host='192.168.81.204',port=3306,user='root',passwd='666666',db='monitor_ping',charset='utf8')
    cur = conn.cursor()
    return (conn,cur)
...
def connDB1():
    if socket.gethostname() == 'cat.com':
        ...
        conn=  pymysql.connect(host='192.168.81.204',port=3306,user='root',passwd='666666',db='super_plate_gate',charset='utf8')
    cur = conn.cursor()
    return (conn,cur)
def connDB2():
    if socket.gethostname() == 'cat.com':
        conn=  pymysql.connect(host='127.0.0.1',port=3306,user='root',passwd='666666',db='remote_bak_server',charset='utf8')
    else:
        conn=  pymysql.connect(host='192.168.81.204',port=3306,user='root',passwd='666666',db='remote_bak_server',charset='utf8')
    cur = conn.cursor()
    return (conn,cur)
def connDB_cm():
    conn=  pymysql.connect(host='192.168.81.204',user='root',passwd='666666',db='provinces_test_cm',charset='utf8')
    cur = conn.cursor()
    return (conn,cur)
def connDB_un():
    conn=  pymysql.connect(host='192.168.81.2041',user='root',passwd='666666',db='provinces_test_un',charset='utf8')
    cur = conn.cursor()
    return (conn,cur)
def connDB_cdma():
    conn=  pymysql.connect(host='192.168.81.204',user='root',passwd='666666',db='spcard',charset='utf8')
    cur = conn.cursor()
    return (conn,cur)
#def connDB_cdma1():
...
#    return (conn,cur)
def connDB_auto():
    conn=  pymysql.connect(host='192.168.81.2041',user='root',passwd='666666',db='sms_server',charset='utf8')
    cur = conn.cursor()
    return (conn,cur)
def connDB_yw(server,dbname,port):
    ...
    return (conn,cur)
def connDB_RS():
    conn=  pymysql.connect(host='192.168.81.204',user='root',passwd='666666',db='repository',charset='utf8')
    cur = conn.cursor()
    return (conn,cur)
